...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group fixed bottom-4 left-4 z-40 inline-flex h-9 w-9 items-center justify-center rounded-full border border-[var(--hair-strong)] bg-[var(--card)] text-[var(--silver)] opacity-65 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.4)] backdrop-blur-sm transition-all duration-300 hover:opacity-100 hover:text-[var(--white)] focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#537FEA]/50"
    >
