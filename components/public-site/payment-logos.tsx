...
const marks: { name: string; node: ReactNode }[] = [
  {
    name: "Visa",
    node: (
      <svg viewBox="0 0 58 20" className="h-[11px] w-auto" aria-hidden="true" fill="currentColor">
        <text
          x="0"
          y="16"
          fontSize="20"
  ...
  },
  {
    name: "Mastercard",
    node: (
      <svg viewBox="0 0 34 20" className="h-[15px] w-auto" aria-hidden="true" fill="currentColor">
  ...
  },
  {
    name: "Apple Pay",
    node: (
      <svg viewBox="0 0 52 24" className="h-[14px] w-auto" aria-hidden="true" fill="currentColor">
  ...
  },
  {
    name: "Google Pay",
    node: (
      <svg viewBox="0 0 54 24" className="h-[14px] w-auto" aria-hidden="true">
  ...
  },
  {
    name: "Stripe",
    node: (
      <svg viewBox="0 0 360 150" className="h-[10px] w-auto" aria-hidden="true" fill="currentColor">
  ...
  },
  {
    name: "PayPal",
    node: (
      <svg viewBox="0 0 30 24" className="h-[15px] w-auto" aria-hidden="true" fill="currentColor">
...
export function PaymentLogos({ className = "" }: { className?: string }) {
  return (
    <ul
      ...
      className={`flex flex-wrap items-center gap-x-5 gap-y-3 text-[var(--faint)] opacity-[0.58] ${className}`}
    >
      {marks.map((m) => (
        <li
          key={m.name}
